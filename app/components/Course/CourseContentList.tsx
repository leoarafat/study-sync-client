  ...
  return (
    ...
    >
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        const sectionStartIndex: number = sectionVideoCount; // Start index of videos within the current section
            ...
            {isSectionVisible && (
              <div className="w-full">
                {sectionVideos.map((item: any, index: number) => {
                  const videoIndex: number = sectionStartIndex + index; // Calculate the video index
