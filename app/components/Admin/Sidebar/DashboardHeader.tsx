...
const DashboardHeader: FC<Props> = () => {
  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0">
      ...
      {open && (
        <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 right-2 z-10 rounded">
          <h5 className="text-center text-[20px] font-Poppins bg-[#3ccbae] text-white p-3 rounded-t">
            Notifications
          </h5>
          ...
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#00000001] p-2">
